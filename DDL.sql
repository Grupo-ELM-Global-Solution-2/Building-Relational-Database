...
CREATE TABLE ddd_trilha(
    id_tri NUMBER(5) GENERATED BY DEFAULT AS IDENTITY CONSTRAINT PK_TRILHA PRIMARY KEY,        
...
CREATE TABLE ddd_modulo(
    id_mod NUMBER(5) GENERATED BY DEFAULT AS IDENTITY CONSTRAINT PK_MODULO PRIMARY KEY,
    nome VARCHAR2(100) NOT NULL,
...
CREATE TABLE ddd_prog(
    id_prog NUMBER(5) GENERATED BY DEFAULT AS IDENTITY CONSTRAINT PK_PROG PRIMARY KEY,
...
CREATE INDEX idx_prog_user ON ddd_prog(id_user);
CREATE INDEX idx_prog_modulo ON ddd_prog(id_mod);
